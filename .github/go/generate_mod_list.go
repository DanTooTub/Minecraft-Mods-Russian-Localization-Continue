// Сценарий для генерации списка локализованных модов
// Создаёт файл current_proofread_dates.json с информацией о вычитке локализаций, устанавливает переменные окружения GitHub Actions с данными для выпусков, форматирует информации о модах для документации.
