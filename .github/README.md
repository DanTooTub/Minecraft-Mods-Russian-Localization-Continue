[Работа над оригинальным проектом (от Дефлекты) приостановлена.](https://github.com/RushanM/Minecraft-Mods-Russian-Translation/issues/64)

---

# Русский перевод модификаций Minecraft от ~~Дефлекты~~ теперь DanTooTub

<div align="center">
    <img title="В будущем заменю эту картинку" src="https://github.com/DanTooTub/Minecraft-Mods-Russian-Localization-Continue/blob/beta/%D0%90%D1%81%D1%81%D0%B5%D1%82%D1%8B/preview2.png?raw=true">
    <br>
    <br>
...
Дефлекту не устраивало то, какой обычно бывает перевод на русский в модах для Minecraft, и поэтому он решил сам улучшить их переводы, а также добавить русский перевод туда, где его нет.

Но вскоре он заморозил проект. Тогда я (DanTooTub) решил сделать продолжение проекта.
...
⚠️ Таблица может стать неактуальной, так-как будет создан бот для авто апдейта и публикования сборок. Но произойдёт это не скоро так-как кодить я не умею, а те скрипты что вы возможно видели, это скрипты Дефлекты, а работают они или нет, я не знаю.

* `1.7—1.21` — версии игры
* ⬛ — мода нет на эту версию
* ⚠️ — Перевод отсутствует или в разработке
...
| [Industrial Craft](https://www.curseforge.com/minecraft/mc-mods/industrial-craft) | 🟥 | 🟥 | ⬛ | ⬛ | ⬛ | ⬛ | ⚠️ | ⬛
...
Системаверсий будет слегка отличаться, он оригинальной, но она всё ещё будет понятной.
...
<div align="center">
    <img title="Хаос, хаос!? Нет, нет! Порядок, порядок!" height="300" src=https://github.com/DanTooTub/Minecraft-Mods-Russian-Localization-Continue/blob/master/assets/1.21-1.1.png?raw=true>
</div>
...
* [**DanTooTub**](https://github.com/DanTooTub): Продолжил перевод
...
Контакты оригинального разработчика найдёте в репозитории.
